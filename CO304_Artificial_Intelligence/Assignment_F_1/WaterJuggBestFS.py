...
# Object for showing a state
# It also has the priority criteria
# The more fuller the jugs, higher the
# priority they're assigned
class state(object):
